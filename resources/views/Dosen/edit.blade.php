...
<div class="container">
    <form action="{{ route('dosen.update', $data['id']) }}" method="POST" style="position: relative; top: 5em">
          {{ csrf_field() }}
          @method('PUT')
        ...
        <div class="form-group">
          ...
          <input type="text" autocomplete="off" class="form-control" id="NIP" name="NIP" value="{{$data['NIP']}}">
        </div>
